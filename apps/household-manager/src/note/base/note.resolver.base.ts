...
export class NoteResolverBase {
  ...
  async author(@graphql.Parent() parent: Note): Promise<User | null> {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Thread, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Thread",
    action: "read",
    possession: "any",
  })
  async thread(@graphql.Parent() parent: Note): Promise<Thread | null> {
