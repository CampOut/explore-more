...
export class UserResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [CorkBoard])
  @nestAccessControl.UseRoles({
    resource: "CorkBoard",
    action: "read",
    possession: "any",
  ...
  async corkBoards(
    ...
    const results = await this.service.findCorkBoards(parent.id, args);
  ...
  async household(@graphql.Parent() parent: User): Promise<Household | null> {
